function transformLocations(locations) {
    return locations.map(location => {
        const { date, name, img, desc, ...rest } = location;
        
        return {
            ...rest,
            name: name, // Swap date with name
            detail: [{ date, img, desc }], // Insert detail attribute as an array
        };
    });
}
...
var transformedLocations = transformLocations(locations);
